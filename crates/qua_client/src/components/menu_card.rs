...
pub fn menu_card<'menu>(cx: Scope<'menu, MenuCardProps<'menu>>) -> Element {
    cx.render(rsx! {
        Link { to: "{cx.props.to}", class: "menu-card",
            div { class: "menu-card-top {cx.props.color_accent_class}",
                span { img {
            ...
            div { class: "menu-card-bottom",
                div { class: "header", "{cx.props.header}" }
                div { class: "paragraph", "{cx.props.description}" }
            }
        }
    })
}
